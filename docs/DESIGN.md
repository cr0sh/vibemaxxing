...
Updates on the app, e.g. new messages, newly added items to shop, should mark the app "updated",
which will make the app icon bouncing on the dock bar(sharing the previous
implementation of "newly added apps/windows").
